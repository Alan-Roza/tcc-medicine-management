...
class UserHealthInfoPage extends StatelessWidget {
  const UserHealthInfoPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Informaçoẽs de Saúde'),	
        centerTitle: true,
      ...
      body: Column(
        children: [
            ...
            child: ListView(
              ...
              // Menu options
                _buildMenuItem(
                Icons.person_outline, 'Informações Gerais', '', context, false, () => context.goNamed('GeneralHealthInfo')),
                _buildMenuItem(Icons.medical_services, 'Alergia a Medicamentos', '', context,
                false, () => context.goNamed('UserAllergyInfoPage')),
                _buildMenuItem(Icons.local_hospital, 'Doenças Crônicas', '', context,
                false, () => context.goNamed('UserChronicalDiseaseInfoPage')),
              ],
            ),
            ),
