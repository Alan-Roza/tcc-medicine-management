...
class MaterialTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      secondary: Color(0xff1c4666),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff52789a),
      ...
      secondaryFixed: Color(0xff52789a),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff395f80),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff1c4666),
      onSecondaryContainer: Color(0xffffffff),
      ...
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff1c4666),
      onSecondaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      secondary: Color(0xffa4caf0),
      onSecondary: Color(0xff013352),
      secondaryContainer: Color(0xff154060),
      onSecondaryContainer: Color(0xffafd5fb),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      secondary: Color(0xffa8cff5),
      onSecondary: Color(0xff00182a),
      secondaryContainer: Color(0xff6f94b8),
      ...
      secondaryFixedDim: Color(0xffa4caf0),
      onSecondaryFixedVariant: Color(0xff0a3958),
      tertiaryFixed: Color(0xffcde5ff),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      secondaryContainer: Color(0xffa8cff5),
      onSecondaryContainer: Color(0xff000000),
      ...
      secondaryFixedDim: Color(0xffa8cff5),
